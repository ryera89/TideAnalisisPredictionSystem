...
GeneralidadesPage::GeneralidadesPage(QWidget *parent):QWizardPage(parent)
{
    ...
    m_descrMarInstGroupBox = new QGroupBox(tr("Descripción de la instalación del mareógrafo"));
    m_descrAveriasGroupBox = new QGroupBox(tr("Datos sobre averías en los dispositivos de nivel"));

    m_descrCostaTextEdit = new QPlainTextEdit;
    m_descrCostaTextEdit->setPlaceholderText(tr("estabilidad, relieve de fondo, distribución de las profundidades, etc."));
    m_descrMareografoTextEdit = new QPlainTextEdit;
    m_descrMareografoTextEdit->setPlaceholderText(tr("número, tipo, período de función, etc."));
    m_descrMarInstTextEdit = new QPlainTextEdit;
    m_descrMarInstTextEdit->setPlaceholderText(tr("distancia de la costa, profundidad, método de instalación, etc."));
    m_descrAveriasTextEdit = new QPlainTextEdit;
    m_descrAveriasTextEdit->setPlaceholderText(tr("número de la regla, mareógrafo, carácter de la avería, medidas tomadas, nivelaciones de control, etc."));
