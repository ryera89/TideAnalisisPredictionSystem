...
ChapasPage::ChapasPage(QWidget *parent):QWizardPage(parent)
{
    ...
    m_descrChapaPartidaGroupBox = new QGroupBox(tr("Datos de la chapa de partida"));
    m_descrChapaPrincipalGroupBox = new QGroupBox(tr("Datos de la chapa principal"));
    m_descrChapaTrabajoGroupBox = new QGroupBox(tr("Datos de la chapa de trabajo"));

    m_descrChapaPartidaTextEdit = new QPlainTextEdit;
    m_descrChapaPartidaTextEdit->setPlaceholderText(tr("número, año de establecimiento, nombre del organismo, quién colocó la chapa, "
                                                       "situación de la chapa, etc."));

    m_descrChapaPrincipalTextEdit = new QPlainTextEdit;
    m_descrChapaPrincipalTextEdit->setPlaceholderText(tr("número, año de establecimiento, nombre del organismo, quién colocó la chapa, "
                                                       "situación de la chapa, etc."));

    m_descrChapaTrabajoTextEdit = new QPlainTextEdit;
    m_descrChapaTrabajoTextEdit->setPlaceholderText(tr("número, año de establecimiento, nombre del organismo, quién colocó la chapa, "
                                                       "situación de la chapa, etc."));
