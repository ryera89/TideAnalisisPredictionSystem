...
ReportWindow::ReportWindow(QWidget *parent) : QMainWindow(parent)
{
   ...
   m_printAsPdfAction = new QAction(QIcon(":images/pdfPrint.png"),tr("Imprimir como pdf"));
   connect(m_printAsPdfAction,&QAction::triggered,this,&ReportWindow::printPDF);
...
{
    QString fileName = QFileDialog::getSaveFileName(this,tr("Exportar como PDF"),QString(),"*.pdf");
