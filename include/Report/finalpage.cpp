...
QString FinalPage::procesoDpto() const { return m_procesoDptoEdit->text(); }

QString FinalPage::revisoNombre() const {
  return m_revisoNombreEdit->text() + " " + m_revisoApellidosEdit->text();
}

QString FinalPage::revisoDpto() const { return m_revisoDptoEdit->text(); }

QString FinalPage::proceso() const { return m_procesoGroupBox->title() + ":"; }

QString FinalPage::reviso() const { return m_revisoGroupBox->title() + ":"; }
