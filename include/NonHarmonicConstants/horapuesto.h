...
class HoraPuesto {
public:
  HoraPuesto(const HarmonicConstant &M2, const HarmonicConstant &S2,
             const HPM &hpm);
...
private:
  ...
  const QString m_description =
      "Valor del intervalo Lunar, cuando la Luna pasa a través del "
      "meridiano del lugar simultáneamente con el Sol, con la condición que la "
      "Luna"
      " y el sol se encuentran en el ecuador , a distancias medias de la "
      "tierra. "
      "Tomando en cuenta que la luna culmina al mediodía o a medianoche, "
      "entonces "
