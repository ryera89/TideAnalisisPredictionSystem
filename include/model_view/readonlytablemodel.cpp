...
void ReadOnlyTableModel::setMeasurements(
    const QVector<TidesMeasurement> &measurement) {
  beginResetModel();
  m_data = measurement;
  endResetModel();
}
...
/*void ReadOnlyTableModel::setMeasurements(const QVector<TidesMeasurement>
&measurement)
{
    beginResetModel();
