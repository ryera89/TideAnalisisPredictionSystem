...
TidalTableDelegate::TidalTableDelegate(QObject *parent)
    : QStyledItemDelegate(parent) {}
void TidalTableDelegate::paint(QPainter *painter,
...
QWidget *TidalTableDelegate::createEditor(QWidget *parent,
                                          const QStyleOptionViewItem &option,
                                          const QModelIndex &index) const {
  if (index.column() == dateColumn) {
    ...
    connect(dateEdit, SIGNAL(editingFinished()), this,
            SLOT(commitAndCloseDateEditor()));
    return dateEdit;
  }
  if (index.column() == timeColumn) {
  ...
  if (index.column() == levelColumn) {
    ...
    connect(levelEdit, SIGNAL(editingFinished()), this,
            SLOT(commitAndCloseLevelEditor()));
    return levelEdit;
  }
...
void TidalTableDelegate::setEditorData(QWidget *editor,
                                       const QModelIndex &index) const {
  if (index.column() == dateColumn) {
...
void TidalTableDelegate::setModelData(QWidget *editor,
