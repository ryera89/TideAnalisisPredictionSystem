...
HarmonicConstantFullTableModel::HarmonicConstantFullTableModel(QObject *parent)
...
int HarmonicConstantFullTableModel::columnCount(
    const QModelIndex &parent) const {
  Q_UNUSED(parent)
  return 7;
}

QVariant HarmonicConstantFullTableModel::data(const QModelIndex &index,
                                              int role) const {
  if (!index.isValid())
    return QVariant();
...
QVariant HarmonicConstantFullTableModel::headerData(int section,
...
void HarmonicConstantFullTableModel::setAllData(
