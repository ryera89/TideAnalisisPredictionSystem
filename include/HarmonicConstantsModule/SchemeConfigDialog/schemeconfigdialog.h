...
#include <QDialog>
#include "include/HarmonicConstantsModule/tidalschemeselectionwidget.h"
//#include "mylistwidget.h"
//#include "Model_View/mylistmodel.h"
#include "include/HarmonicConstantsModule/Model_View/mylistmodeldelegate.h"
#include "include/HarmonicConstantsModule/Model_View/mylistview.h"
...
public:
    explicit SchemeConfigDialog(const QStringList &schemesLabels, const QStringList &componentsLabels,const QMap<QString,QMap<QString,bool>> &schemes_componentMap,const QMap<QString,QString> &schemeDescription, QWidget *parent = 0,Qt::WindowFlags f = Qt::WindowFlags());
    QStringList schemes() const;
    QMap<QString,QMap<QString,bool>> schemeComponentStatus() const;
    QMap<QString,QString> schemeDescription() const {return m_schemesDescriptionMap;}

private slots:
    void updateSchemeDescription();
    void selectAnalisisScheme(const QModelIndex &current, const QModelIndex &previous); //Este slot es el que me permite al cambiar de esquema en la vista que se me acualicen los checkBoxes
...
private:
    ...
    void createComponent(const QStringList &schemesLabels, const QStringList &componentsLabels);
    void settingLayout();
