...
public:
  explicit DoodsonNumbers()
      : m_d1(0), m_d2(0), m_d3(0), m_d4(0), m_d5(0), m_d6(0), m_extended(0) {}
  explicit DoodsonNumbers(int d1, int d2, int d3, int d4, int d5, int d6,
                          int extended)
      : m_d1(d1), m_d2(d2), m_d3(d3), m_d4(d4), m_d5(d5), m_d6(d6),
        m_extended(extended) {}
...
inline bool operator==(const DoodsonNumbers &doodson1,
                       const DoodsonNumbers &doodson2) {
  return (doodson1.D1() == doodson2.D1() && doodson1.D2() == doodson2.D2() &&
          doodson1.D3() == doodson2.D3() && doodson1.D4() == doodson2.D4() &&
          doodson1.D5() == doodson2.D5() && doodson1.D6() == doodson2.D6() &&
