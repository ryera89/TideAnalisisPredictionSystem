...
public:
    ...
    enum Origin{SOLAR, LUNAR_LONGPERIOD_1, LUNAR_LONGPERIOD_2, LUNAR_DIURNAL_1, LUNAR_DIURNAL_2, LUNAR_DIURNAL_3,
               COMBINATION_DIURNAL_1, COMBINATION_DIURNAL_2, LUNAR_SEMIDIURNAL_1,LUNAR_SEMIDIURNAL_1_2, LUNAR_SEMIDIURNAL_2,
               COMBINATION_SEMIDIURNAL_1, COMBINATION_SEMIDIURNAL_2, LUNAR_TERDIURNAL, SHALLOW_1, SHALLOW_2, SHALLOW_3,
               SHALLOW_COMB_1, SHALLOW_COMB_2, SHALLOW_COMB_3};
    ...
    HarmonicConstant();
    HarmonicConstant(const QString &name, const double &frequency, const DoodsonNumbers &doodsonNumber, Origin orig);
    HarmonicConstant(const QString &name, const double &frequency, const double &C, const double &S, const DoodsonNumbers &doodsonNumber, Origin orig);
