...
ManualHarmonicConstantsModel::ManualHarmonicConstantsModel(QObject *parent)
...
ManualHarmonicConstantsModel::ManualHarmonicConstantsModel(
    const QVector<HarmonicConstant> &datos, QObject *parent)
...
QVariant ManualHarmonicConstantsModel::data(const QModelIndex &index,
                                            int role) const {
  if (!index.isValid())
    return QVariant();
...
QVariant ManualHarmonicConstantsModel::headerData(int section,
...
bool ManualHarmonicConstantsModel::setData(const QModelIndex &index,
...
Qt::ItemFlags
ManualHarmonicConstantsModel::flags(const QModelIndex &index) const {
...
void ManualHarmonicConstantsModel::setAllData(
