...
double metaDataWidget::ceroPuesto() const { return m_ceroPuestoEdit->value(); }
...
double metaDataWidget::latitud() const { return m_latitudEdit->coordinate(); }

double metaDataWidget::longitud() const { return m_longitudEdit->coordinate(); }
...
void metaDataWidget::setCeroPuestoValueAndUnit(
    MeasurementUnitEditWidget::Units unit, double value) {
  m_ceroPuestoEdit->setSpinAndComboBoxesValues(unit, value);
}

void metaDataWidget::setNivelReferenciaValueAndUnit(
    MeasurementUnitEditWidget::Units unit, double value) {
