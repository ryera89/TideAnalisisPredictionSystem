...
//--------------------------------------------------------------
NumericalVector operator+(const NumericalVector &nv1,
                          const NumericalVector &nv2) {
  ...
  if (nv1.size() == nv2.size()) {
    ...
    throw Error("Bad size in vector sum");
}
NumericalVector operator-(const NumericalVector &nv1,
                          const NumericalVector &nv2) {
  if (nv1.size() == nv2.size()) {
    ...
    throw Error("Bad size in vector rest");
}
...
double operator*(const NumericalVector &nv1, const NumericalVector &nv2) {
  if (nv1.size() == nv2.size()) {
    ...
    throw Error("Incompatible arrays sizes.");
}
