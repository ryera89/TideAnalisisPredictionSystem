...
M2, K1, O1, M4 y de L (que es Altura del NMM sobre el cero de profundidad que se
toma para dicha carta. (altura del NMM con respecto al NMT o NMB ).*/
...
public:
  explicit AlturaSemimarea(const HarmonicConstant &M2,
