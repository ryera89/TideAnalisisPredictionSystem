...
displayResultWidget::displayResultWidget(const QString &title, QWidget *parent)
...
QString displayResultWidget::lineEditText() const { return m_lineEdit->text(); }
...
void displayResultWidget::createComponets() {
  ...
  connect(m_pushButton, SIGNAL(clicked(bool)), this,
