...
private:
  ...
  }; // Numero magico para reconocer si el archivo leido es correcto

  QString m_filePath; // Direccion del archivo donde se guardan las freq de las
...
public slots:
  ...
  // bool writeFile(const QString &filePath);   //Copia la info de la tabla para
  // el archivo especificado en m_filePath
...
public:
  ...
  HarmonicConstantFrequencyTableModel *harmonicConstantsModel() const {
